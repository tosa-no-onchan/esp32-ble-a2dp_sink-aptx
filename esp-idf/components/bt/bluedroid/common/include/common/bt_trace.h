...
// changed by nishi
#define AVDT_TRACE_WARNING(fmt, args...)    BT_PRINT_W("BT_AVDT", fmt, ## args)
...
// changed by nishi
#define AVDT_TRACE_EVENT(fmt, args...)      BT_PRINT_D("BT_AVDT", fmt, ## args)
...
// changed by nishi for DEBUG
//#define AVDT_TRACE_DEBUG(fmt, args...)      BT_PRINT_D("BT_AVDT", fmt, ## args)
...
// changed by nishi for DEBUG
//#define APPL_TRACE_EVENT(fmt, args...)      BT_PRINT_D("BT_APPL", fmt, ## args)
...
// changed by nishi for DEBUG
//#define APPL_TRACE_DEBUG(fmt, args...)      BT_PRINT_D("BT_APPL", fmt, ## args)
...
// changed by nishi
//#define BTC_TRACE_DEBUG(fmt, args...)      BT_PRINT_D("BT_BTC", fmt, ## args)
