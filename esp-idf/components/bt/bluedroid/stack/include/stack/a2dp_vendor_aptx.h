...
#include "stack/a2dp_vendor_aptx_constants.h"
...
//extern tA2D_STATUS A2DP_ParseInfoAptx(tA2DP_APTX_CIE* p_ie,const uint8_t* p_codec_info,bool is_capability);
extern tA2D_STATUS A2DP_ParseInfoAptx(tA2DP_APTX_CIE* p_ie,const uint8_t* p_codec_info,bool is_capability,char *caller_s);
