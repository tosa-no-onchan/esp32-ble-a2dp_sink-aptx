...
#define ESP_A2D_MCT_NON_A2DP    (0xff)			/*!< APTX */
...
#define ESP_A2D_CIE_LEN_APTX        (7)			/* add by nishi for APTX 2019.1.24  */
    union {
        ...
        uint8_t aptx[ESP_A2D_CIE_LEN_APTX];		/* add by nishi for APTX 2019.1.24  */
